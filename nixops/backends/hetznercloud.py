...
# TODO Add support for creating the required NixOS snapshot using clever's kexec method:
#      https://github.com/cleverca22/nix-tests/blob/master/kexec/session.md
